                                        ...
                                        <div class="navbar navbar-default" role="navigation">
                                            ...
                                            <div class="navbar-collapse collapse sidebar-navbar-collapse">
                                                <ul class="nav navbar-nav text-left">
                                                    ...
                                                    <li>
                                                        <div id="div_medicos" runat="server">
                                                            <asp:LinkButton CssClass="buttonClass" ID="lkb_medicos" runat="server">
                                                                <i class="fas  fa-shopping-cart"></i>
                                                                <asp:Label CssClass="buttonClass" ID="lbl_medicos" runat="server" Text="Medicos"> </asp:Label>
                                                            </asp:LinkButton>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div id="div_escolar" runat="server">
                                                            <asp:LinkButton CssClass="buttonClass" ID="lkb_escolar" runat="server">
                                                                <i class="fas  fa-dolly"></i>
                                                                <asp:Label CssClass="buttonClass" ID="lbl_escolar" runat="server" Text="Escolar"> </asp:Label>
                                                            </asp:LinkButton>
                                                        </div>
                                                    </li>
                                                    <li>
